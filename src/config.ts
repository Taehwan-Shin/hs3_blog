...
export const siteConfig: SiteConfig = {
  ...
  defaultOgImageAlt: "고교삼국 대표 이미지", // Alt text for the default Open Graph image, public/open-graph.png
  ...
  customThemeFile: "bliss-soft", // Only used if theme is set to "custom" above. Filename in src/themes/custom/ (without .ts extension)
  ...
  fonts: {
    ...
    families: {
      // [CONFIG:FONT_BODY]
      body: "Pretendard",      // Body text font family
      // [CONFIG:FONT_HEADING]
      heading: "Pretendard",   // Heading font family  
      // [CONFIG:FONT_MONO]
  ...
  postOptions: {
    ...
    customPostCardAspectRatio: "3 / 1", // Only used when postCardAspectRatio is "custom" (e.g., "2.5/1")
    comments: {
